...
function M.register(handlers)
  ...
  AddEventHandler("PropHunt_DecoyPlace", handlers.onDecoyPlace)
  print("DEBUG: Registered handler for PropHunt_DecoyPlace")
  AddEventHandler("PropHunt_DecoyDenied", handlers.onDecoyDenied)
  print("DEBUG: Registered handler for PropHunt_DecoyDenied")
